  ...
  document.getElementById('modal-body').innerHTML=`
    <div class="ld-layout">
      ...
      <div>
        ...
        ${!isOwn?`<button class="btn btn-mkt w100" style="margin-top:20px" onclick="contactSeller('${l.user_id||''}','${escJsAttr(l.seller_nick||'')}')">${icon('messageCircle',13,"display:inline-block;vertical-align:-2px;margin-right:6px")}${T('mkt_contact')}</button>`:''}
        ...
        <div class="fx-c gap8" style="margin-top:14px;flex-wrap:wrap">
