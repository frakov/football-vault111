    ...
    <div style="display:flex;flex-direction:column;gap:14px">
      <div class="card">
        ...
        <div class="fx-c gap14" style="gap:14px;margin-top:8px">
          ...
          <div>
            <div style="font-family:'Inter',sans-serif;font-weight:800;font-size:22px;letter-spacing:.06em">${escapeHtml(p.nick||'—')}</div>
            ${p.bio?`<div style="font-size:12px;color:var(--t2);margin-top:3px">${escapeHtml(p.bio)}</div>`:''}
